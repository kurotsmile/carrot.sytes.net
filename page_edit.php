...
<div style="float: left;width: 100%">
    <form style="float: left;padding: 20px;font-size: 13px;" method="post" action="">
        ...
        <table>
            <tr>
                ...
                <td>
                    ...
                    <span class="buttonPro small" onclick="copy_text_to('#song_title','#name_file');"><i class="fa fa-arrow-up" aria-hidden="true"></i></span>
                    <span class="buttonPro small" onclick="switch_title();"><i class="fa fa-retweet" aria-hidden="true"></i></span>
                </td>
            </tr>
            ...
            <tr>
                ...
                <td>
                    ...
                    <span class="buttonPro small" onclick="add_artist();"><i class="fa fa-arrow-up" aria-hidden="true"></i></span>
                </td>
            </tr>
            ...
            <tr>
                <td>Lời bài hát</td>
                <td>
                    <textarea name="song_lyrics" id="song_lyrics" style="width: 300px"><?php echo $song_lyrics;?></textarea>
                </td>
            </tr>
        </table>
        ...
        <a href="<?php echo $url;?>/file/<?php echo  $id_file;?>" class="buttonPro "><i class="fa fa-chevron-circle-left" aria-hidden="true"></i>
            Xem thông tin</a>
    </form>
</div>

    ...
    <ul id="menu_header">
        ...
        <?php if (isset($_SESSION['user_login'])) { ?>
            ...
            <li style="float: right">
                <a href="<?php echo $url; ?>?logout=1"><i class="fa fa-sign-out" aria-hidden="true"></i> <?php echo $_SESSION['full_name_login'];?></a>
            </li>
        <?php } ?>
    </ul>
</div>
